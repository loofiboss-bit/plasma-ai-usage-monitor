...
This matrix is generated from the same Catalog v7 descriptors used by the widget. Connectivity never implies account-wide usage or spend. All scheduled calls are read-only; manual inference tests are separate and may consume quota or money.
