...
> **Current release:** `v8.0.2` fixes subscription-plan defaults for GitHub Copilot Pro+ and current ChatGPT Pro Codex tiers, while preserving catalog-backed source and precision metadata from v8.0.0.
