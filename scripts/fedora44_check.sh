...
if python3 scripts/check_provider_catalog.py; then ok "Provider Catalog v5"; else fail "Provider Catalog v5 invalid" "Update package/contents/catalog/providers-v4.json."; fi
