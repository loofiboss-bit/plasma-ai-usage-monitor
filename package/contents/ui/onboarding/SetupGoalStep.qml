...
ColumnLayout {
    ...
    PlasmaComponents.Label {
        visible: controller.recommendedSource.stableId !== undefined
        Layout.fillWidth: true
        wrapMode: Text.WordWrap
        font.bold: true
        text: i18n("Recommended: %1 — %2",
                   controller.recommendedSource.displayName || "",
                   controller.monitoringLevelLabel(controller.recommendedSource))
    }
    ...
    Repeater {
        ...
        PlasmaComponents.Button {
            ...
            onClicked: controller.chooseGoal(modelData.key)

            PlasmaComponents.ToolTip { text: modelData.detail }
        }
    }
}
