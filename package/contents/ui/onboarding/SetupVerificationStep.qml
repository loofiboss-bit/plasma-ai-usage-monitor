...
ColumnLayout {
    ...
    PlasmaExtras.Heading { level: 4; text: i18n("Verify %1", step.controller.selectedSource.displayName || i18n("source")) }
    ...
    PlasmaComponents.Label {
        ...
        text: step.controller.statusMessage || i18n("Running a read-only verification…")
    }
    PlasmaComponents.Label {
        Layout.fillWidth: true
        horizontalAlignment: Text.AlignHCenter
    ...
    RowLayout {
        ...
        PlasmaComponents.Button { text: i18n("Try again"); onClicked: step.controller.retryVerification() }
    }
}
