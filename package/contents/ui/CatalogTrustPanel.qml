        ...
        model: [
            {
                ...
                verificationState: ProviderPricingCatalog.verificationState,
                sequence: ProviderPricingCatalog.sequence,
                hardExpiresAt: ProviderPricingCatalog.hardExpiresAt,
                estimatesAllowed: ProviderPricingCatalog.estimatesAllowed,
                freshnessSloDays: ProviderPricingCatalog.freshnessSloDays,
        ...
        delegate: ColumnLayout {
            ...
            RowLayout {
                ...
                PlasmaComponents.Label {
                    Layout.fillWidth: true
                            text: i18n("%1: schema %2, catalog %3, sequence %4, reviewed %5, state %6, expires %7, estimates %8, runtime scraping %9, review items %10, conflicts %11",
                               catalogRow.modelData.label,
                               catalogRow.modelData.schemaVersion,
                               catalogRow.modelData.catalogVersion,
                               catalogRow.modelData.sequence || i18n("n/a"),
                               catalogRow.modelData.lastReviewed,
                               catalogRow.modelData.verificationState,
                               catalogRow.modelData.hardExpiresAt || i18n("not set"),
                               catalogRow.modelData.estimatesAllowed ? i18n("allowed") : i18n("stopped"),
